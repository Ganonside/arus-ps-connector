 ...
 */
var interceptFault = function (resp) {
  /* gets the response's 2nd-level node */
  var body = resp[Object.keys(resp)[0]];
    ...
    return new Promise(function (resolve, reject) {
      Request.post(requestParams).then(function (res) {
        ...
        if (fault) {
          ...
          var _subjects = Serializer.subjects(jRes, model);
          resolve(_subjects);
        }
    ...
    return new Promise(function (resolve, reject) {
      Request.post(params).then(function (res) {
        ...
        if (fault) {
          ...
          var _notifications = Serializer.notifications(jRes, model);
