...
var Subjects = _interopRequire(require("./models/Subjects.js"));

var Courses = _interopRequire(require("./models/Courses.js"));

var Notification = _interopRequire(require("./models/Notification.js"));

var NtfEvents = _interopRequire(require("./models/NtfEvents.js"));

var NtfEvent = _interopRequire(require("./models/NtfEvent.js"));

var Lov = _interopRequire(require("./models/Lov.js"));

var UCIDLookup = _interopRequire(require("./models/UCIDLookup.js"));

var Fault = _interopRequire(require("./models/Fault.js"));
...
var Serializer = (function () {
  ...
  _createClass(Serializer, null, {
    ...
    courses: {
      value: function courses(coursesData) {
        var model = arguments[1] === undefined ? Courses : arguments[1];
    ...
    eventsCount: {
      ...
      value: function eventsCount(eventsData) {
        var model = arguments[1] === undefined ? NtfEvents : arguments[1];
    ...
    UCIDLookup: {
      ...
      value: (function (_UCIDLookup) {
        var _UCIDLookupWrapper = function UCIDLookup(_x) {
          return _UCIDLookup.apply(this, arguments);
        };

        _UCIDLookupWrapper.toString = function () {
          return _UCIDLookup.toString();
        };

        return _UCIDLookupWrapper;
      })(function (UCIDData) {
        var model = arguments[1] === undefined ? UCIDLookup : arguments[1];

        return model.create(serialize(UCIDData.UC_IT_PERSON_GET_RESP));
      })
    },
    lovs: {
      value: function lovs(lovData) {
        var model = arguments[1] === undefined ? Lov : arguments[1];

        var lovs = [];
        lovs = lovData.SCC_LOV_RESP.LOVS[0].LOV.map(function (lov) {
    ...
    fault: {
      value: function fault(faultData) {
        var model = arguments[1] === undefined ? Fault : arguments[1];

        var fault = new model(serialize(faultData));
