...
var SearchResult = _interopRequire(require("./models/SearchResult.js"));
...
var Serializer = (function () {
  ...
  _createClass(Serializer, null, {
    ...
    searchResult: {
      value: function searchResult(searchResultData) {
        var model = arguments[1] === undefined ? SearchResult : arguments[1];
